...
require (
	github.com/BurntSushi/toml v1.5.1-0.20250606162815-011fa2bc64ce
	github.com/cheggaaa/pb/v3 v3.1.7
	github.com/gobwas/glob v0.2.3
	github.com/mattn/go-isatty v0.0.20
	github.com/osbuild/blueprint v1.16.0
	github.com/osbuild/bootc-image-builder/bib v0.0.0-20251118172055-b20891fec9aa
	github.com/osbuild/images v0.221.0
