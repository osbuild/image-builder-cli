...
func generateManifest(dataDir, extraRepoPath string, img *imagefilter.Result, output io.Writer, opts *manifestOptions) error {
	repos, err := newRepoRegistry(dataDir, extraRepoPath)
	if err != nil {
		return err
	}
